 ...
 *
 * 抽出来只为一件事：`clam-app/host/scripts/prebuild-plugins.mjs`（分发计划 M3，
 ...
 *
 * @module clam-bridge/swift-payload
 */
 ...
 *
 * 由 `clam-app/host/scripts/pack-payload.mjs` 写进打包出来的每个
 * `ClamNode/<pkg>/swift/`，随镜像一路拷进 `<profile>/.surfclam/<pkg>/swift/`。
 ...
 */
export const STATIC_MARKER = ".clam-static";
