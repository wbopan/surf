 ...
 *
 *   1. clam-notify 的通知文案（标题/正文/按钮由 node 组好，Swift 收到什么画什么）；
 ...
 * clam-notify 要一个活的读取口，注册 description 的地方只要"此刻是哪门语言"。
 *
 * **为什么住在 clam-bridge**：本仓库 clam-* 之间一律相对路径 import，而**所有**
 * 箭头都指向 clam-bridge（`./plugin.js` 那条），它是天然的底座。反过来让 clam-bridge
 * 去 import clam-notify 就把"缺席即无通知"的可选插件变成了特权插件的硬依赖。
 *
 * @module clam-bridge/locale
 */
