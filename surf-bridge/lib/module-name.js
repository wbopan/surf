 ...
 *
 * 单独成模块，只为一件事：`surf-app/host/scripts/pack-payload.mjs` 也要用它
 * （把各插件的 `swift/` 打进 app bundle 的 `Resources/SurfPlugins/<Module>/sources/`，
 ...
 * 未必解析得到它们。
 *
 * @module surf-bridge/module-name
 */

/** `surf-sidebar` → `SurfSidebar`。结果必须是一个合法的 Swift 标识符。 */
