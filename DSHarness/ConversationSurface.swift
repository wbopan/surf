...
/// dsharness-web-adapter 插件暴露的 `window.__dsharness`。
...
final class WebViewConversationSurface: ConversationSurface {
    ...
    private func call(_ fn: String, args: [String]) {
        let script = "(window.__dsharness && typeof window.__dsharness.\(fn) === 'function') ? window.__dsharness.\(fn)(\(args.joined(separator: ","))) : undefined"
