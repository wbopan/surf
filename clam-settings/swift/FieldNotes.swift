...
enum FieldNotes {
    ...
    static func title(ns: String, path: [String], locale: ClamLocale) -> String {
    ...
    static func optionLabel(ns: String, path: [String],
                            value: JSONValue, locale: ClamLocale) -> String {
...
enum NamespaceNotes {
    ...
    private static let table: [String: Note] = [
        ...
        "clam-nativeify": Note(title: .init("原生观感", "Native Feel"),
        ...
        "clam-notify": Note(title: .init("通知", "Notifications"),
    ...
    static func title(ns: String, locale: ClamLocale) -> String {
        table[ns]?.title[locale] ?? SettingsFormat.humanize(ns)
    }

    static func summary(ns: String, locale: ClamLocale) -> String? {
