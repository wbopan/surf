...
# Never touches the installed Release app (Surf) — Dev/Release are
...
APP_NAME="Surf Dev"               # Debug product name (project.yml configs.Debug)
RELEASE_NAME="Surf"               # installed Release app name
TARGET_NAME="surf"
CONFIGURATION="Debug"
DERIVED_DATA="build"
