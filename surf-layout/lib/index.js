/**
 * surf-layout —— 窗口布局（计划 §7.1）。
 *
 * node 半边只做三件事：把 `swift/` 登记给桥、声明本插件的菜单命令，以及 provide 一个空标记服务
 * `surf-layout` 让 surf-sidebar 能 inject 它（§4.3）——Cordis 的依赖解析由此保证
