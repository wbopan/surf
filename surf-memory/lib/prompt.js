 ...
 *
 * 权威计划：docs/archive/surf-memory-plan.md §2.3（注入什么）、§4（提示词文案）、§8 执行日志。
 */
...
export const SECTION_MEMORIES = "surf-memory:memories";
export const SECTION_MAINTENANCE = "surf-memory:maintenance";
