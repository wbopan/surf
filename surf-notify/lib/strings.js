/**
 * 通知文案表（计划 `docs/archive/surf-i18n-plan.md` §5 的 node 侧那一半）。
 *
 ...
 *
 * @module surf-notify/strings
 */
import { FALLBACK } from "../../surf-bridge/lib/locale.js";
...
function verifyTables() {
	...
	for (const [locale, table] of Object.entries(TABLES)) {
		...
		throw new Error(`surf-notify 文案表 ${locale} 与 zh 对不上：`
			+ [
