/**
 * surf-notify 的 node 侧语言决议（计划 `docs/archive/surf-i18n-plan.md` §3 末段）。
 *
 * **为什么 surf-notify 要自己算一遍**：全仓其余面向用户的文案都在 Swift 里，
 * 语言经 `surf.locale` 粘性总线送到；只有通知的标题/正文/按钮是 node 组好的
 ...
 *
 * 决议链的头两级是纯函数，与 surf-app / surf-bridge 选 description 语言时用的是
 * 同一份（`surf-bridge/lib/locale.js`）——**接线各家自己写，规则只有一份**。
 *
 * @module surf-notify/locale
 */
